...
- Implementación de un ejercicio de algoritmia en **Java**.
- Simulación del desplazamiento de una tortuga mediante instrucciones básicas.
...
```bash
git clone https://github.com/juandiegogalindo/EjercicioAlgoritmia-Tortuga.git
```
...
1. Se modela un estado inicial (posición y dirección).
2. Se procesan instrucciones secuenciales.
3. Se emplean ciclos para repetir acciones.
4. Se usan condicionales para tomar decisiones.
